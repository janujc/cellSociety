...
public class Fire extends Simulation {
     ...
     */
    public Fire(int sideSize, int[] states, double[] populationFreqs, Color[] stateColors, Double probCatch) {
        super(sideSize, states, populationFreqs, stateColors, probCatch);
